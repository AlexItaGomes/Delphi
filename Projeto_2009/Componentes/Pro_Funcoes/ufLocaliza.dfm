object fLocaliza: TfLocaliza
  ...
  object GroupBox1: TGroupBox
    ...
    Align = alTop
    Caption = 
      'Informe um Valor para &Pesquisar ( * A pesquisa ser'#225' realizada e' +
      'm todos os campos )'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    ...
    object edtPesq: TEdit
      ...
      Height = 21
      Hint = 
        'Pesquisa |'#13#10'Informe uma valor ou parte de um valor que o sistema' +
        ' far'#225' a pesquisa para voc'#234#13#10'|0'
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 242
      Height = 13
      Caption = '- Duplo clique ou OK para selecionar o registro'
      Font.Charset = ANSI_CHARSET
      Font.Color = clNavy
      Font.Height = -11
      Font.Name = 'Segoe UI'
  ...
  object GroupBox2: TGroupBox
    ...
    object grdBasico: TDBGrid
      ...
      Height = 435
      Hint = 
        'Pesquisa |'#13#10'Selecione o registro e clique em OK ou ENTER para re' +
        'tornar o registro'#13#10'|0'
      CustomHint = BalloonHint
      Align = alClient
      Ctl3D = True
      DataSource = dsLocal
  ...
  object BalloonHint: TBalloonHint
    Images = imgButtons_24_x_24
    Left = 504
    Top = 232
  end
  object imgButtons_24_x_24: TImageList
    Left = 424
    Top = 232
  end
end
