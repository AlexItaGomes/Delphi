inherited fRel_Saida_Avaria_Analitica: TfRel_Saida_Avaria_Analitica
  Caption = 'fRel_Saida_Avaria_Analitica'
  ExplicitWidth = 1045
  ExplicitHeight = 828
  PixelsPerInch = 96
  TextHeight = 13
  inherited qrepRelatorio: TQuickRep
    DataSet = dmRel_Saida_Avaria.cdsRelSaidaAvaria
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    ReportTitle = 'Relat'#243'rio Sa'#237'da Produtos Avaria'
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      DataSet = dmRel_Saida_Avaria.cdsItensSaidaAvaria
      PrintBefore = False
      PrintIfEmpty = True
