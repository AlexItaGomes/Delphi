inherited fRel_Marcas_Prod_Sinteticos: TfRel_Marcas_Prod_Sinteticos
  Caption = 'fRel_Marcas_Prod_Sinteticos'
  ExplicitWidth = 1045
  ExplicitHeight = 828
  PixelsPerInch = 96
  TextHeight = 13
  inherited qrepRelatorio: TQuickRep
    Left = -3
    DataSet = dmRel_Marcas_Produtos.cdsRelMarcas
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    ReportTitle = 'Relat'#243'rio Sint'#233'tico de Marcas'
    ExplicitLeft = -3
