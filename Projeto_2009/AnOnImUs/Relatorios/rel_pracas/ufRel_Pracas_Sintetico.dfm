inherited fRel_Pracas_Sintetico: TfRel_Pracas_Sintetico
  Caption = 'fRel_Pracas_Sintetico'
  ExplicitWidth = 1045
  ExplicitHeight = 828
  PixelsPerInch = 96
  TextHeight = 13
  inherited qrepRelatorio: TQuickRep
    DataSet = dmRelPracas.cdsRelPracas
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    ReportTitle = 'Relat'#243'rio Sintetico de Pra'#231'as'
