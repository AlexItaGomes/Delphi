inherited fRel_Curva_ABC_Estoque_Sintetico: TfRel_Curva_ABC_Estoque_Sintetico
  Caption = 'fRel_Curva_ABC_Estoque_Sintetico'
  ExplicitWidth = 1053
  ExplicitHeight = 816
  PixelsPerInch = 96
  TextHeight = 13
  inherited qrepRelatorio: TQuickRep
    ...
    ReportTitle = 'Relat'#243'rio Curva ABC Estoque'
    ExplicitLeft = -3
