unit ufRel_Contas_Pagar_Analitico;
...
type
  TfRel_Contas_Pagar_Analitico = class(TfImpressoes)
    QRLabel3: TQRLabel;
    QRLabel4: TQRLabel;
    QRLabel5: TQRLabel;
    QRLabel6: TQRLabel;
...
var
  fRel_Contas_Pagar_Analitico: TfRel_Contas_Pagar_Analitico;
...
procedure TfRel_Contas_Pagar_Analitico.QRBand3BeforePrint(Sender: TQRCustomBand;
