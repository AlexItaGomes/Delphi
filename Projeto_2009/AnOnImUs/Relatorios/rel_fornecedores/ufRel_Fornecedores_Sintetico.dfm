inherited fRel_Fornecedores_Sintetico: TfRel_Fornecedores_Sintetico
  Caption = 'fRel_Fornecedores_Sintetico'
  ClientWidth = 1366
  ExplicitLeft = -340
  ExplicitWidth = 1382
  ExplicitHeight = 784
  ...
  inherited qrepRelatorio: TQuickRep
    ...
    Width = 1684
    Height = 1191
    DataSet = dmRel_Fornecedores.cdsRel_Fornecedores
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    ReportTitle = 'Relat'#243'rio Sint'#233'tico de Fornecedores'
    ExplicitLeft = -624
    ExplicitTop = -8
    ExplicitWidth = 1684
    ExplicitHeight = 1191
