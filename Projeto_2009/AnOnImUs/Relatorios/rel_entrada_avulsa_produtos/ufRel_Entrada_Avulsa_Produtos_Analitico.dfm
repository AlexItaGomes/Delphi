inherited fRel_Entr_Avulsa_Produtos_Analitico: TfRel_Entr_Avulsa_Produtos_Analitico
  Caption = 'fRel_Entr_Avulsa_Produtos_Analitico'
  ExplicitWidth = 1045
  ExplicitHeight = 828
  PixelsPerInch = 96
  TextHeight = 13
  inherited qrepRelatorio: TQuickRep
    DataSet = dmRel_Entr_Avulsa_Produtos.cdsRelEntradaAvulsa
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    ReportTitle = 'Relat'#243'rio de Entrada Avulsa de Produtos'
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      DataSet = dmRel_Entr_Avulsa_Produtos.cdsItensEntradaAvulsa
      PrintBefore = False
      PrintIfEmpty = True
