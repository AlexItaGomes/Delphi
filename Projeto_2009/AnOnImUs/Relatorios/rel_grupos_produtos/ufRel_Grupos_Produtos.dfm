inherited fRel_Grupos_Produtos: TfRel_Grupos_Produtos
  Caption = 'fRel_Grupos_Produtos'
  ExplicitWidth = 1050
  ExplicitHeight = 550
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited panelSuperior: TPanel
    inherited Label1: TLabel
      Width = 223
      Caption = 'Rel. de Grupos de Produtos'
      ExplicitTop = 4
      ExplicitWidth = 223
    end
  end
    ...
    inherited Page1: TfrxReportPage
      ...
      inherited ReportTitle1: TfrxReportTitle
        ...
        inherited Memo14: TfrxMemoView
          ...
          Memo.UTF8W = (
            'Rela'#231#227'o de Grupos de Produtos')
        end
  ...
  inherited dstRelatorio: TfrxDBDataset
    DataSource = dmRel_Grupos_Produtos.dsRelGrupos
  end
end
