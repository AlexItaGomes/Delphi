inherited fRel_Grupos_Produtos_Sintetico: TfRel_Grupos_Produtos_Sintetico
  Caption = 'fRel_Grupos_Produtos_Sintetico'
  ExplicitWidth = 1045
  ExplicitHeight = 828
  PixelsPerInch = 96
  TextHeight = 13
  inherited qrepRelatorio: TQuickRep
    Left = -3
    Top = -8
    DataSet = dmRel_Grupos_Produtos.cdsRelGrupos
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    ReportTitle = 'Relat'#243'rio Sint'#233'tico de Grupos'
    ExplicitLeft = -3
    ExplicitTop = -8
