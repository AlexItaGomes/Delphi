inherited fCadTabelaPreco: TfCadTabelaPreco
  Caption = 'Cad. Tabela de Pre'#231'o'
  ...
  inherited pageCadastro: TPageControl
    inherited tabCadastro: TTabSheet
      ...
      object DBEdit1: TDBEdit
        ...
        DataField = 'TPRC_ID'
        DataSource = dmTabelaPreco.dsTabelaPreco
        ReadOnly = True
        TabOrder = 0
      end
      ...
      object GroupBox1: TGroupBox
        ...
        Height = 290
        Align = alBottom
        Caption = 'Produtos da Tabela de Pre'#231'o'
        TabOrder = 4
      ...
      object GroupBox2: TGroupBox
        ...
        object edtDtVigencia: TDBDateEdit
          Left = 576
          Top = 32
          Width = 100
          Height = 21
          ...
          Margins.Left = 4
          Margins.Top = 1
          DataField = 'TPIT_DTA_VIGENCIA'
          DataSource = dmTabelaPreco.dsItensTabelaPreco
          NumGlyphs = 2
          TabOrder = 3
        end
        object edtDtValidade: TDBDateEdit
          Left = 681
          Top = 32
          Width = 100
          Height = 21
          ...
          Margins.Left = 4
          Margins.Top = 1
          DataField = 'TPIT_DTA_VALIDADE'
          DataSource = dmTabelaPreco.dsItensTabelaPreco
          NumGlyphs = 2
          TabOrder = 4
        end
        object edtVlrGondola: TRxDBCalcEdit
          Left = 5
          Top = 73
          Width = 130
          Height = 21
          ...
          Margins.Left = 4
          Margins.Top = 1
          DataField = 'TPIT_VLR_GONDOLA'
          DataSource = dmTabelaPreco.dsItensTabelaPreco
          DisplayFormat = '###,###,##0.0000'
          ButtonWidth = 0
          NumGlyphs = 2
          TabOrder = 5
          OnExit = edtVlrGondolaExit
        end
        object edtVlrMinimo: TRxDBCalcEdit
          Left = 150
          Top = 73
          Width = 130
          Height = 21
        ...
        object edtVlrEspecial: TRxDBCalcEdit
          Left = 296
          Top = 73
          Width = 130
          Height = 21
        ...
        object edtVlrAtacado: TRxDBCalcEdit
          Left = 442
          Top = 73
          Width = 130
          Height = 21
